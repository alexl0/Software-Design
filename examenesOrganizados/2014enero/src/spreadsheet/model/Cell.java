...
public class Cell {
	...
	/**
	 * Crea una celda con la dirección especificada. Es también necesario (al menos,
	 * en esta versión inicial que se os entrega) asignarle una referencia a la hoja
	 * de calcula a la que pertenece para que esta celda pueda resolver las
	 * referencias a celdas en las fórmulas y obtener así el valor de éstas.
	 * 
	 ...
	 *                    en el formato habitual de las hojas de cálculo (A1, C3,
	 *                    etcétera), donde las letras representan la columna y el
	 *                    número la fila de la celda
	 */
	...
	/**
	 * Devuelve la dirección de esta celda. La dirección de una celda identifica la
	 * posición de ésta en la hoja de cálculo, y está formada por la combinación de
	 * una o varias letras representando la <i>columna</i> y un número que
	...
	/**
	 * Devuelve el valor numérico de esta celda. Puede ser el valor introducido tal
	 * cual en la celda, como un número, por el usuario, o bien el resultado de
	 ...
	 * sobreescribiendo cualquier otro contenido que tuviese previamente la celda,
	 * lo que quiere decir que, en caso de que esta celda contuviese una fórmula,
	 * ésta se eliminará.
	 * 
	...
	/**
	 * Establece la fórmula especificada como contenido de esta celda y actualiza el
	 * valor de la celda.
	 * 
	...
	public void setFormula(String formulaText) {
		...
		if (arguments.length < 2)
			throw new IllegalArgumentException(
					"Todas las fórmulas (salvo las referencias a celdas) necesitan al menos dos parámetros");
	...
	/**
	 * Devuelve una representación textual de esta celda. Dicho valor consiste en
	 ...
	 * 
	 * <p>
	 * Donde {dirección} es la dirección de la celda, {valor} su valor numérico (el
	 * que se le haya introducido o el resultado de evaluar su fórmula, según
	 * corresponda) y {fórmula} una representación textual normalizada de la fórmula
	 * (nombre en mayúsculas y sin espacios, paréntesis sin espacios, referencias a
	 * celdas también en mayúsculas y separadas por punto y coma más exactamente un
