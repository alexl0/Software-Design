...
public class AppVersion4 {
	...
	public void openWindow() {
		...
		/*
		 * +--------------------+----------------+ | Nombre | Propietario |
		 * +--------------------+----------------+ | Despacito | Luis Fonsi | | Dragon's
		 * Kiss | Marty Friedman | | El Código Da Vinci | Dan Brown | | Design Patterns
		 * | Erich Gamma | | Galaxy S8 | Samsung | | iPhone 8 | Apple |
		 * +--------------------+----------------+
		 */
