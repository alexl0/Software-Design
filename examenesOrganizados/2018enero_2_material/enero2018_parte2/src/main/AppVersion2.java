...
public class AppVersion2 {
	...
	public void openWindow() {
		...
		// ---------------------------------------------------------------------------------
		// A) Mostrar los móviles en una tabla (que ponga "Modelo" y "Marca" en la
		// cabecera)

		/*
		 * +-----------+---------+ | Modelo | Marca | +-----------+---------+ | Galaxy
		 * S8 | Samsung | | iPhone 8 | Apple | +-----------+---------+
		 */
		 ...
		 * +--------------------+-------------+----------------+---------+ | El Código
		 * Da Vinci | Dan Brown | Planeta | Español | | Design Patterns | Erich Gamma |
		 ...
		 * +--------------------+----------------+-------------+ | Título | Propietario
		 * | Información | +--------------------+----------------+-------------+ |
		 * Galaxy S8 | Samsung | | | iPhone 8 | Apple | | | Despacito | Luis Fonsi |
		 * Latino | | Dragon's Kiss | Marty Friedman | Metal | | El Código Da Vinci |
		 * Dan Brown | Español | | Design Patterns | Erich Gamma | Español |
		 * +--------------------+----------------+-------------+
		 */
