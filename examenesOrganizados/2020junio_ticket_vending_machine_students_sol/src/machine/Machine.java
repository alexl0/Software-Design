...
{	
	private enum PaymentMode { CREDIT_CARD, CASH, PAYPAL }
	...
	private PaymentMode selectPaymentMode()
	{
		...
		case 3: return PaymentMode.PAYPAL;
	 ...
	 */
	/*
	private boolean payByPaypal(double amount)
	{
	...
	/* Version sin patron
	private double applyCode(String code, double amount) {
		...
		if(code.equals("15EURACOS")) {
			return amount - 15;
		}else if(code.equals("VERANO20")){
			return amount - 20;
		}else if(code.equals("FREE1")) {
			return amount - (selectedEvent.getPrice());
		}
