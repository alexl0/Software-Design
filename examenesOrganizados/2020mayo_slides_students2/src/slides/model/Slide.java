...
public class Slide implements Cloneable {
	...
	public void show(Canvas canvas) {
		layout.getType().show(canvas, layout);
	}
	...
	public String toString() {
		return String.format("Diapositiva con %d marcadores de posición%n  => %s", layout.getPlaceholders().size(),
				layout);
	}
...
//    		slide.layout = (Layout) layout.clone();
			return slide;
