...
public class Canvas {
	...
	public Canvas() {
		this(new BufferedReader(new InputStreamReader(System.in)), new OutputStreamWriter(System.out));
		interactive = true;
	}
	...
	/*
	 * Como 'drawLine' pero sin imprimir el carácter de nueva línea. Resulta útil
	 * para cuando por ejemplo queremos preguntar al usuario que introduzca un valor
	 * justo a continuación de una cadena de texto, sin que escriba su respuesta en
	 * otra lína. En general, en cualquier caso en que queramos concatenar mensajes
	 * en la salida sin que cada uno de ellos vaya en una línea aparte. Sería el
	 * equivalente del 'print', mientras que 'drawLine' es el equivalente de
	 * 'println'.
	 */
	...
	/*
	 * Imita lo que sería el dibujado por pantalla, en nuestro caso escribiendo en
	 * la salida que se haya especificado en el constructor una nueva línea de
	 * texto.
	 */
