...
public class Remote 
{
	public enum Button { ONE, TWO, THREE, FOUR, FIVE, SIX }
	...
	{
		switch (button) {
		case ONE: return "Encender/apagar el televisor";
		case TWO: return "Poner el canal 1 del televisor";
		case THREE: return "Poner el canal 3 del televisor";
		case FOUR: return "Poner el canal 15 del televisor";
		case FIVE: return "Subir el volumen del televisor";
		case SIX: return "Bajar el volumen del televisor";
		}
