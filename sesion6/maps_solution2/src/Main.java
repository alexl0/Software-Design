...
public class Main {
	public static void main(String[] args) {
		...
		// añadir al mapa).
		MonumentMapElement coliseo = new MonumentMapElement("Coliseo", "Vespasiano",
				"Piazza del Colosseo, 1, 00184 Roma, Italia");
		PhotoMapElement myPhoto = new PhotoMapElement("Colosseum in Rome, Italy - April 2007", "DAVID ILIFF",
