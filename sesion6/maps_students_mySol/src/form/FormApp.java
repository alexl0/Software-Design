...
public class FormApp {
	public static void main(String[] args) {
		...
		Photo photoColosseum = new Photo("Colosseum in Rome, Italy - April 2007", "DAVID ILIFF",
		...
		// Tarea 1. Editar también el restaurante: que se puedan editar el nombre y la
		// dirección
