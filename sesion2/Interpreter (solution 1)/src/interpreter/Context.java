...
public class Context 
{
	 ...
	 * haría falta guardarlo en ningún sitio aparte de en el propio intérprete, al hacerlo
	 * aquí permitimos realizar comprobaciones en las operaciones de esta clase que modifican
