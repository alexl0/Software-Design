...
public class Interpreter {
	...
	/**
	 * Devuelve el contexto del intérprete. El contexto contiene todos los elementos
	 * que representan el estado actual del intérprete (pila, puntero de pila,
	 * memoria y contador de programa), junto con las operaciones que los manipulan,
	 * y que es la información que se pasa como parámetros a todas las instrucciones
	 * al llamar a su método {@code execute}.
	 * <p>
	 * 
	 ...
	 * absoluto (las instrucciones no hacen uso de él, porque ya lo reciben como
	 * parámetro). Se podría eliminar (eliminando las pruebas unitarias),
