...
public class Main {
	public static void main(String[] args) {
		...
		/*
		 * No compila System.out.println("\n--- Recorrido ideal: no compila");
		 * IdealVersion ideal = new IdealVersion(); ideal.visit(program);
		 */

		// Tenéis que hacer que funcione lo siguiente
		System.out.println("\n--- Recorrido con el patrón Visitor: hecho");
