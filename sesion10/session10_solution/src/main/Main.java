...
public class Main {
	public static void main(String[] args) throws Exception {
		...
		// Generar HTML con sólo los cuatro primeros caracteres de los nombres de la
		// lista.
		...
		// % Opción 2
		writeHtml(new Map(s -> "Don " + s,
				new Map(s -> s.toUpperCase(), new Filter(s -> s.length() == 8, queue.iterator()))));
	}
