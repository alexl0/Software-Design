...
public class Application 
{
	...
	//Herramientas
	public SelectionTool herramientaDeSeleccion;
	public RectangleCreationTool herramientaDeCreacionDeRectangulo = new RectangleCreationTool();
	public CircleCreationTool herramientaDeCreacionDeCirculo = new CircleCreationTool();
	public TriangleCreationTool herramientaDeCreacionDeTriangulo = new TriangleCreationTool();
	...
	{
		herramientaDeSeleccion = new SelectionTool(figuras);
